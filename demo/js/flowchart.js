...
jsPlumb.ready(function() {
  ...
  var connectorPaintStyle = {
    ...
    sourceEndpoint = {
      ...
      connector: [
        "Flowchart",
        { stub: [40, 60], gap: 5, cornerRadius: 5, alwaysRespectStubs: true }
      ],
  ...
  $("#startEv").mousedown(function() {
    loadProperties(
      "window start custom jtk-node jsplumb-connected",
      "5em",
      "5em",
      "start",
      ["BottomCenter"],
  ...
  $("#stepEv").mousedown(function() {
    loadProperties(
      "window step custom jtk-node jsplumb-connected-step",
      "5em",
      "5em",
      "step",
      ["BottomCenter"],
  ...
  $("#descEv").mousedown(function() {
    loadProperties(
      "window diamond custom jtk-node jsplumb-connected-step",
      "5em",
      "5em",
      "decision",
      ["LeftMiddle", "RightMiddle", "BottomCenter"],
      ["TopCenter"],
      true,
      100,
      100
  ...
  $("#endEv").mousedown(function() {
    loadProperties(
      "window end custom jtk-node jsplumb-connected-end",
      "5em",
      "5em",
      "end",
      [],
  ...
  function createElement(id, name) {
    ...
    var strong = $("<strong>");
    if (
      properties[0].clsName ==
      "window diamond custom jtk-node jsplumb-connected-step"
    ) {
      elm.append(
        "<i style='display: none; margin-left: -5px; margin-top: -50px' " +
          'class="fa fa-trash fa-lg close-icon desc-text"></i>'
      );
      var p =
        "<p style='line-height: 110%; margin-top: 25px' class='desc-text' contenteditable='true' " +
      ...
      properties[0].clsName ==
      "window parallelogram step custom jtk-node jsplumb-connected-step"
    ) {
      elm.append(
        "<i style='display: none' class=\"fa fa-trash fa-lg close-icon input-text\"></i>"
      );
      var p =
        "<p style='line-height: 110%; margin-top: 25px' class='input-text' contenteditable='true' " +
        "ondblclick='$(this).focus();'>" +
        properties[0].label +
        "</p>";
      strong.append(p);
      ...
      elm.append(
        "<i style='display: none' class=\"fa fa-trash fa-lg close-icon\"></i>"
      );
      var p =
        "<p style='line-height: 110%; margin-top: 25px' contenteditable='true' " +
        "ondblclick='$(this).focus();'>" +
        properties[0].label +
        "</p>";
      strong.append(p);
  ...
  function getEndpoints(elementType) {
    switch (elementType) {
      ...
      case "decision":
        return [["LeftMiddle", "RightMiddle", "BottomCenter"], ["TopCenter"]];
      case "end":
        return [[], ["TopCenter"]];
    }
  }
